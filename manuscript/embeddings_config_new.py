...
# # ---------------- WT vs FUS lines, FUS marker ----------------
# class newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch1(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_All):
#     def __init__(self):
#         super().__init__()
#         self.INPUT_FOLDERS = [os.path.join(self.PROCESSED_FOLDER_ROOT, "ManuscriptFinalData_80pct", "neuronsDay8_new", "batch1")]


# class newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch2(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_All):
#     def __init__(self):
#         super().__init__()
#         self.INPUT_FOLDERS = [os.path.join(self.PROCESSED_FOLDER_ROOT, "ManuscriptFinalData_80pct", "neuronsDay8_new", "batch2")]


# class newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch3(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_All):
#     def __init__(self):
#         super().__init__()
#         self.INPUT_FOLDERS = [os.path.join(self.PROCESSED_FOLDER_ROOT, "ManuscriptFinalData_80pct", "neuronsDay8_new", "batch3")]


# class newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch7(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_All):
#     def __init__(self):
#         super().__init__()
#         self.INPUT_FOLDERS = [os.path.join(self.PROCESSED_FOLDER_ROOT, "ManuscriptFinalData_80pct", "neuronsDay8_new", "batch7")]


# class newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch8(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_All):
#     def __init__(self):
#         super().__init__()
#         self.INPUT_FOLDERS = [os.path.join(self.PROCESSED_FOLDER_ROOT, "ManuscriptFinalData_80pct", "neuronsDay8_new", "batch8")]


# class newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch9(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_All):
#     def __init__(self):
#         super().__init__()
#         self.INPUT_FOLDERS = [os.path.join(self.PROCESSED_FOLDER_ROOT, "ManuscriptFinalData_80pct", "neuronsDay8_new", "batch9")]

   
# # ---------------- WT vs FUSRevertant, FUS marker ----------------
# class newNeuronsD8FigureConfig_WT_vs_FUSRevertant_FUSMarker_Batch1Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch1):
#     def __init__(self):
#         super().__init__()
...
# class newNeuronsD8FigureConfig_WT_vs_FUSRevertant_FUSMarker_Batch2Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch2):
#     def __init__(self):
#         super().__init__()
#         self.CELL_LINES = ['WT', 'FUSRevertant']
#         self.CONDITIONS = ['Untreated']
...
# class newNeuronsD8FigureConfig_WT_vs_FUSRevertant_FUSMarker_Batch3Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch3):
#     def __init__(self):
#         super().__init__()
#         self.CELL_LINES = ['WT', 'FUSRevertant']
#         self.CONDITIONS = ['Untreated']
...
# class newNeuronsD8FigureConfig_WT_vs_FUSRevertant_FUSMarker_Batch7Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch7):
#     def __init__(self):
#         super().__init__()
#         self.CELL_LINES = ['WT', 'FUSRevertant']
#         self.CONDITIONS = ['Untreated']
...
# class newNeuronsD8FigureConfig_WT_vs_FUSRevertant_FUSMarker_Batch8Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch8):
#     def __init__(self):
#         super().__init__()
#         self.CELL_LINES = ['WT', 'FUSRevertant']
#         self.CONDITIONS = ['Untreated']
...
# class newNeuronsD8FigureConfig_WT_vs_FUSRevertant_FUSMarker_Batch9Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch9):
#     def __init__(self):
#         super().__init__()
#         self.CELL_LINES = ['WT', 'FUSRevertant']
#         self.CONDITIONS = ['Untreated']
...
# # ---------------- WT vs FUSHeterozygous, FUS marker ----------------
# class newNeuronsD8FigureConfig_WT_vs_FUSHeterozygous_FUSMarker_Batch1Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch1):
#     def __init__(self):
#         super().__init__()
...
# class newNeuronsD8FigureConfig_WT_vs_FUSHeterozygous_FUSMarker_Batch2Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch2):
#     def __init__(self):
#         super().__init__()
#         self.CELL_LINES = ['WT', 'FUSHeterozygous']
#         self.CONDITIONS = ['Untreated']
...
# class newNeuronsD8FigureConfig_WT_vs_FUSHeterozygous_FUSMarker_Batch3Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch3):
#     def __init__(self):
#         super().__init__()
#         self.CELL_LINES = ['WT', 'FUSHeterozygous']
#         self.CONDITIONS = ['Untreated']
...
# class newNeuronsD8FigureConfig_WT_vs_FUSHeterozygous_FUSMarker_Batch7Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch7):
#     def __init__(self):
#         super().__init__()
#         self.CELL_LINES = ['WT', 'FUSHeterozygous']
#         self.CONDITIONS = ['Untreated']
...
# class newNeuronsD8FigureConfig_WT_vs_FUSHeterozygous_FUSMarker_Batch8Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch8):
#     def __init__(self):
#         super().__init__()
#         self.CELL_LINES = ['WT', 'FUSHeterozygous']
#         self.CONDITIONS = ['Untreated']
...
# class newNeuronsD8FigureConfig_WT_vs_FUSHeterozygous_FUSMarker_Batch9Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch9):
#     def __init__(self):
#         super().__init__()
#         self.CELL_LINES = ['WT', 'FUSHeterozygous']
#         self.CONDITIONS = ['Untreated']
...
# # ---------------- WT vs FUSHomozygous, FUS marker ----------------
# class newNeuronsD8FigureConfig_WT_vs_FUSHomozygous_FUSMarker_Batch1Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch1):
#     def __init__(self):
#         super().__init__()
...
# class newNeuronsD8FigureConfig_WT_vs_FUSHomozygous_FUSMarker_Batch2Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch2):
#     def __init__(self):
#         super().__init__()
#         self.CELL_LINES = ['WT', 'FUSHomozygous']
#         self.CONDITIONS = ['Untreated']
...
# class newNeuronsD8FigureConfig_WT_vs_FUSHomozygous_FUSMarker_Batch3Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch3):
#     def __init__(self):
#         super().__init__()
#         self.CELL_LINES = ['WT', 'FUSHomozygous']
#         self.CONDITIONS = ['Untreated']
...
# class newNeuronsD8FigureConfig_WT_vs_FUSHomozygous_FUSMarker_Batch7Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch7):
#     def __init__(self):
#         super().__init__()
#         self.CELL_LINES = ['WT', 'FUSHomozygous']
#         self.CONDITIONS = ['Untreated']
...
# class newNeuronsD8FigureConfig_WT_vs_FUSHomozygous_FUSMarker_Batch8Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch8):
#     def __init__(self):
#         super().__init__()
#         self.CELL_LINES = ['WT', 'FUSHomozygous']
#         self.CONDITIONS = ['Untreated']
...
# class newNeuronsD8FigureConfig_WT_vs_FUSHomozygous_FUSMarker_Batch9Subset(newNeuronsD8FigureConfig_WT_vs_FUSLines_FUSMarker_Batch9):
#     def __init__(self):
#         super().__init__()
#         self.CELL_LINES = ['WT', 'FUSHomozygous']
#         self.CONDITIONS = ['Untreated']
...
#                                                 "SQSTM1", "HNRNPA1", "CLTC", "FUS", "NEMO", "LSM14A", "SNCA", "Calreticulin", "DCP1A", "ANXA11",
#                                                   "LAMP1", "PEX14", "TOMM20", "TIA1", "Tubulin",
#                                                 "PSD95", "NONO"
#                                             ]
...
#         self.CONDITIONS: List[str] = ["Untreated"]
#         self.MARKERS: List[str] = ["SQSTM1"] #["SQSTM1",  "FUS", "NEMO", "LSM14A", "SNCA", "Calreticulin", "DCP1A", "ANXA11", "HNRNPA1"]
...
#         self.CONDITIONS: List[str] = ["Untreated"]
#         self.MARKERS: List[str] =  ["CLTC", "HNRNPA1"]#["FUS", "LAMP1", "TIA1", "NEMO", "Calreticulin", "Tubulin", "PSD95", "HNRNPA1", "CLTC"]
...
#                                                 "FUS", "NEMO", "LSM14A", "SNCA", "Calreticulin", "DCP1A", "ANXA11",
#                                                 "LAMP1", "PEX14", "TOMM20", "TIA1", "Tubulin",
#                                                 "PSD95", "HNRNPA1", "CLTC", "NONO", "SQSTM1"
#                                             ]
...
#         self.CELL_LINES: List[str] = ["TBK1", "WT"]
#         self.CONDITIONS: List[str] = ["Untreated"]
#         self.MARKERS: List[str] = ["SQSTM1", "FUS", "NEMO", "LSM14A", "SNCA", "Calreticulin", "DCP1A", "ANXA11", "HNRNPA1"]
...
#         self.CELL_LINES: List[str] = ["OPTN", "WT"]
#         self.CONDITIONS: List[str] = ["Untreated"]
#         self.MARKERS: List[str] =  ["FUS", "LAMP1", "TIA1", "NEMO", "Calreticulin", "Tubulin", "PSD95", "HNRNPA1", "CLTC"]
